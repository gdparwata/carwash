...
@section('title','paketcuci')
@section ('content')
    <!-- Hero Section -->
    <section class="relative bg-cover bg-center h-64 sm:h-80 md:h-96" style="background-image: url('{{ asset('storage/images/fotocuci.png') }}');">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                <div class="relative order-2 lg:order-1">
                    <div class="w-64 h-64 sm:w-80 sm:h-80 rounded-full overflow-hidden mx-auto">
                        <img src="{{ asset('storage/images/kategoricucimobil.png') }}" alt="Why Choose Cucicar" class="w-full h-full object-cover">
                    </div>
                </div>
